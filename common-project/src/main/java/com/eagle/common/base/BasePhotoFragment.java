 ...
 */
public abstract class BasePhotoFragment<M extends IModel, V extends IView, P extends BasePresenter> extends BaseFragment<M, V, P> implements TakePhoto.TakeResultListener, InvokeListener {
