package com.eagle.net.cache.policy;
...
import com.eagle.net.db.CacheManager;
import com.eagle.net.exception.HttpException;
import com.eagle.net.model.Response;
import com.eagle.net.request.base.Request;
import com.eagle.net.utils.HeaderParser;
...
public abstract class BaseCachePolicy<T> implements CachePolicy<T> {
    ...
    protected void runOnUiThread(Runnable run) {
        NetManager.getInstance().getDelivery().post(run);
    }
