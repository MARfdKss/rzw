...
import com.eagle.net.convert.Converter;
 ...
 * <p>4.如果缓存不存在才请求网络，否则使用缓存{ CacheMode#IF_NONE_CACHE_REQUEST}<br>
 ...
 * <p>5.先使用缓存，不管是否存在，仍然请求网络{CacheMode#FIRST_CACHE_THEN_REQUEST}<br>
