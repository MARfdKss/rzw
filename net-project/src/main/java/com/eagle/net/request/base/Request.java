package com.eagle.net.request.base;
...
import com.eagle.net.adapter.CacheCall;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    public Request(String url) {
        this.url = url;
        baseUrl = url;
        NetManager go = NetManager.getInstance();
    ...
    public okhttp3.Call getRawCall() {
        ...
        if (client == null) client = NetManager.getInstance().getOkHttpClient();
